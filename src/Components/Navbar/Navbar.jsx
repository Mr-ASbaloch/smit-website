  ...
  return (
    <div className="md:px-[8%] hidden md:flex bg-white shadow-md h-16 py-2 sticky top-0 z-50  ">
      <div className=" flex items-center  gap-11">
        <img
          src="https://www.saylaniwelfareusa.com/static/media/logo_saylaniwelfareusa.22bf709605809177256c.png"
          alt="logo"
        ...
        <div>
          <Link to={"/donate"}>
            <button className="bg-[#0D6DB7] hover:scale-110  mx-3 px-5 text-center p-2 h-[38px] rounded-md text-white">
              Donate Now
            </button>
          </Link>
